...
public class Enemy : Destroyable
{
    ...
    public void FindDestination() {
        navAgent.SetDestination(FindObjectOfType<Player>().transform.position + Random.onUnitSphere * WorldRoot.instance.transform.localScale.x);
    }
    ...
    {
        print(other.transform.parent.name + " " + other.tag);
        Unit attackedBy = other.transform.parent.GetComponent<Unit>();
        Damage(attackedBy.GetAttackDamage());
    }
